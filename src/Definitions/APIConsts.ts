export const APIConsts = {
  ...
  SettingsManager: {
    SettingsCreate: 'gateway.auth.settings.create',
    SettingsDelete: 'gateway.auth.settings.delete',
    SettingsUpdate: 'gateway.auth.settings.update',
    SettingsGetAll: 'gateway.auth.settings.get.all',
    ...
    QuestionLangGetByQuestionId: 'gateway.question.lang.get',
